      ...
      for (var i = 0; i < data.length; i++) {
        ...
        if (settings.mode === 'donut-path'){
          ...
          if (i === 0){
            ...
            var txt = svg.text(startX,startY,'Consumer');
            txt.attr({
            ...
            var txt2 = svg.text(startX,startY+21,visible_text);
            txt2.attr({
              'font-family': 'Open sans',
              'font-size':  18,
              'font-weight': 100,
            ...
            var txtMain = svg.text(cx-(radius/1.5),cy+(radius/3),'IDENTIFIED');
            txtMain.attr({
              'font-family': 'Open sans',
              'font-weight': 600,
              'font-size':  fontSize,
            ...
            var txtMain2 = svg.text(cx-(radius/1.5)+(radius/20),cy+(radius/1.75),'TWEETERS');
            txtMain2.attr({
              'font-family': 'Open sans',
              'font-weight': 600,
              'font-size':  fontSize,
          ...
          if (i === 1){
              ...
              var txt = svg.text(startX,startY,'Business');
              txt.attr({
                'font-family': 'Open sans',
                'font-weight': 600,
                'font-size':  17.5,
              ...
              g.attr({
                transform: 'translate('+(startX-36)+','+(startY-25)+'), scale(1.15)'
                // transform: 'translate('+(startX-36)+',-10), scale(1.15)'
              });
          ...
          if (i === 2){
            ...
            var startX = (paperWidth/2) + cx - 120;
            var startY = 30;
            ...
            var txt = svg.text(startX,startY,'Private');
            txt.attr({
              'font-family': 'Open sans',
              'font-weight': 600,
              'font-size':  17.5,
